...
\institute{Hochschule Mannheim, WS 2017}
...
\begin{frame}[c]{Gradle?!}

\pause

Ausgabe des Befehls \alert{man gradle} im Terminal:
...
\begin{figure}
	\centerline{\includegraphics[width=0.3\textwidth]{pics/hs_mannheim_logo}}
\caption{SSHL Logo}
\end{figure}
